...
/**
 * AeroPal Premium Sidebar Navigation Component
 * 
 * Features:
 * - Modern dark mode with glassmorphism and gradient backgrounds
 * - Responsive navigation with active state indicators
 * - User profile section with quick action buttons
...
// Navigation structure for AeroPal operations platform
...
interface NavGroupProps {
  group: (typeof NAVIGATION_GROUPS)[0]
  currentPath: string
}
